            ...
            children: <Widget>[
              Align(
                ...
                child: Padding(
                  ...
                  child: Text("Rental Period", textAlign: TextAlign.left,
              ...
              Padding(
                ...
                child: Align(
                  alignment: Alignment.centerLeft,
                  child: Text("Which date?", style: TextStyle(fontFamily: 'SF Pro', fontSize: 20, color: Color(0xff000000), fontWeight: FontWeight.w600),),
                ),
              ),
              Padding(
                padding: EdgeInsets.fromLTRB(40, 0, 40, 0),
                child: Align(
                  ...
                  child: ElevatedButton(
                    style: ElevatedButton.styleFrom(backgroundColor: Color(0xff2e9eff)),
              ...
              Padding(
                ...
                child: Align(
                  alignment: Alignment.centerLeft,
                  child: Text("Which time?", style: TextStyle(fontFamily: 'SF Pro', fontSize: 20, color: Color(0xff000000), fontWeight: FontWeight.w600),),
                ),
              ),
              Padding(
                padding: EdgeInsets.fromLTRB(20, 0, 40, 0),
                child: TimeRange(
                  fromTitle: Text("From", style: TextStyle(fontFamily: 'SF Pro', fontSize: 16, color: Color(0xff000000), fontWeight: FontWeight.w600),),
                  toTitle: Text("To", style: TextStyle(fontFamily: 'SF Pro', fontSize: 16, color: Color(0xff000000), fontWeight: FontWeight.w600),),
                  titlePadding: 20,
                  ...
                  activeBackgroundColor: Color(0xff2e9eff),
            ...
            children: <Widget>[
              ...
              TextButton(
                child: const Text("Continue", style: TextStyle(fontFamily: 'SF Pro', fontSize: 20, color: Color(0xffe8e8e8), letterSpacing: 0.01, fontWeight: FontWeight.w500),),
                  onPressed: () {Navigator.of(context).push(MaterialPageRoute(builder: (context)=> BookingProcess3()));
                },
                style: ButtonStyle(
