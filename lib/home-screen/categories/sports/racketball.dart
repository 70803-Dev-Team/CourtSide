...
class RacketballListings extends StatefulWidget {
  ...
  @override
  State<RacketballListings> createState() => _RacketballListingsState();
}

class _RacketballListingsState extends State<RacketballListings> {
  Future<QuerySnapshot>? searchResults;

  initSearchLisiting(String textEntered) {
    searchResults = FirebaseFirestore.instance
        .collection('Listing')
        .where('sport', isEqualTo: 'Racketball')
        .get();
