...
class GolfListings extends StatefulWidget {
  const GolfListings({Key? key}) : super(key: key);

  @override
  State<GolfListings> createState() => _GolfListingsState();
}

class _GolfListingsState extends State<GolfListings> {
  Future<QuerySnapshot>? searchResults;

  initSearchLisiting(String textEntered) {
    searchResults = FirebaseFirestore.instance
        .collection('Listing')
        .where('sport', isEqualTo: 'Golf')
        .get();
