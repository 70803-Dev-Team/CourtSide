...
class SoftballListings extends StatefulWidget {
  const SoftballListings({Key? key}) : super(key: key);

  @override
  State<SoftballListings> createState() => _SoftballListingsState();
}

class _SoftballListingsState extends State<SoftballListings> {
  Future<QuerySnapshot>? searchResults;

  initSearchLisiting(String textEntered) {
    searchResults = FirebaseFirestore.instance
        .collection('Listing')
        .where('sport', isEqualTo: 'Softball')
        .get();
